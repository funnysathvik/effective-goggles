...
random_no = Math.round((Math.random()*quick_draw_data_set.length)+1)
function preload(){
...
function preload(){
    ...
    function classifycanvas{
        classifier.classify(canvas,gotposes);
    }
    ...
    function gotposes(error,results){
            if(error){
                ...
                console.log(results);
                document.getElementById("the").innerHTML = "Your Sketch: "+results[0].label;
